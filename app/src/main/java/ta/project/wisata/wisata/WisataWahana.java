...
public class WisataWahana extends AppCompatActivity {
    RecyclerView recyclerView;
    List<Wisata> wisatas;
    private static final String JSON_URL = "http://panoramawisata.000webhostapp.com/api_wisataWahana";
    Adapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wisata_wahana);
